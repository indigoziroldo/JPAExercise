INSERT INTO tipo_comes_e_bebes
    (id, descricao)
VALUES
    (1, 'Carnes'),
    (2, 'Acompanhamentos'),
...
INSERT INTO comes_e_bebes
    (id, descricao, valor, quantidade, id_tipo_alimento)
VALUES
...
INSERT INTO local
    (id, rua, numero, cep, cidade, estado, complemento,
     vagas_estacionamento, limite_de_pessoas, valor)
VALUES
...
INSERT INTO pessoa
    (id, nome, situacao, telefone, locomocao, data_confirmacao)
VALUES
   (1, 'João', 'C', '(123) 456-7890', 'C', '2024-03-01'),
   (2, 'Maria', 'C', '(987) 654-3210', 'O', '2024-03-02'),
   (3, 'Pedro', 'C', '(111) 222-3333', 'C', '2024-03-02'),
...
INSERT INTO xhurrasco
    (id, data_inicio, data_fim, anfitriao, id_local)
VALUES
...
INSERT INTO pessoa_alimento_xhurrasco
    (id_pessoa, id_alimento, id_xhurrasco, quantidade)
VALUES
